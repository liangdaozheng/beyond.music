<template>
    <div class="main bk">
        ...
        <div class="ims">
            ...
            <div>
                 <img  class="img2" src="img/wy.png" alt="">
            </div>
        </div>
       <div class="inpt" @click="chek">
            <span id="inp"></span>
            <span v-show="mh" class="sel">
                <img src="img/dh.png" alt="">
            </span>
            <span class="fot font">同意</span>
            <span class="font">《服务条款》和《隐私政策》</span>
       </div>
    </div>
</template>
<script>
...
<style scoped>
    ...
    .img1{width: 18px!important;}
    .img2{width: 30px!important;}
    .ims{
        position: absolute;
        left: 15%;
        top:34rem;
    ...
    @keyframes change{
        ...
        100%{width:400px;height: 400px; top:12.5px;left:-10px;opacity: 0;}
    }
    .anm{
        position: absolute;
